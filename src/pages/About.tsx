...
const About = () => {
  return (
    <Layout title="ピアノ教室・リトミック教室検索.orgについて">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  ピアノ教室・リトミック教室検索.orgは、音楽を学びたい人と質の高いピアノ教室・リトミック教室を繋ぐプラットフォームです。
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  <p><span className="font-bold">サービス名：</span>ピアノ教室・リトミック教室検索.org</p>
