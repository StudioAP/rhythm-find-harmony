  ...
  return (
    <>
      <SEOHead 
        ...
        description="全国のピアノ教室・リトミック教室を検索できるサイトです。お近くの教室を見つけて、音楽の素晴らしさを体験してください。月額500円で教室情報を掲載できます。"
        keywords="ピアノ教室,リトミック教室,音楽教室,習い事,子供,大人,レッスン,検索,掲載"
        canonicalUrl="/"
      />
      ...
      <Layout showBreadcrumb={false} className="p-0">
        ...
        <section className="bg-gradient-to-r from-blue-50 to-indigo-50 py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-4">理想のピアノ教室・リトミック教室を見つけよう</h1>
        ...
        <section className="bg-primary/5 py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
                            あなたの教室をピアノ教室・リトミック教室検索.orgに掲載しませんか？<br />
